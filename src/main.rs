...
fn main() {
    ...
    let image = load_png(r"C:\Users\Diabl\Pictures\1200px-Fedora_logo.svg.png", &mut backend).expect("Cannot load image");
    ...
    let (out_frame, shape) = backend.export_frame(output_ptr);
